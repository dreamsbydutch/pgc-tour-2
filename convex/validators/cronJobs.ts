...
const CronJobNameValidator = v.union(
  ...
  v.literal("create_groups_for_next_tournament_12pm"),
  v.literal("create_groups_for_next_tournament_1pm"),
  v.literal("create_groups_for_next_tournament_2pm"),
  v.literal("update_golfers_world_rank_11am"),
);
